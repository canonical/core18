...
The release model of the core18 snap is following rolling releases. 
...
When reporting security issues against the core18 snap, only the latest 
release of the core18 snap is supported.

The core18 snap has regular releases that are fully automated. There are two 
types of security fixes that can be shipped with new versions of the core18 snap.
...
from debian packages carried inside the core18 snap.

<!-- Include end supported versions -->

## What qualifies as a security issue

Security vulnerabilities that apply to packages in the Ubuntu 18.04 LTS archives also shipped by the
core18 snap. Any vulnerability that allows the core18 snap to interfere outside 
...
denial of service etc due to the use of the contents of the core18 snap on the system.

## Reporting a vulnerability

The easiest way to report a security issue is through
[GitHub](https://github.com/canonical/core18/security/advisories/new). See
